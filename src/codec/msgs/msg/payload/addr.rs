...
impl NewFromHex for Addr {
        ...
        I: IntoIterator<Item = &'a u8>,
    {
        ...
        let addr_count =
            var_uint::VarUint::new(it.by_ref()).chain_err(cf!("Error at new VarUint for length"))?;
...
impl IntoBytes for Addr {
    fn into_bytes(&self) -> Result<Vec<u8>> {
        ...
        let mut addr_count = self.addr_count.into_bytes().chain_err(cf!(
